...
import { Clock, Phone, HeartPulse, Shield, CheckCircle, ChevronLeft, ChevronRight } from 'lucide-react';
    ...
    <section className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-16">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="mt-10 flex justify-between">
          <Link to="/" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
